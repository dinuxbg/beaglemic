...
/* 200 * 1000 * 1000 / (49 * 2) / 64 = 31887.7 */
#define BEAGLEMIC_PCM_16CH_SAMPLE_RATE	31888
/* 200 * 1000 * 1000 / (29 * 2) / 128 = 26939.6 */
#define BEAGLEMIC_PCM_8CH_SAMPLE_RATE	26940

#define BEAGLEMIC_PCM_FRAME_NBYTES	(16 * 2)
